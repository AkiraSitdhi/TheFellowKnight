...
public class Fireball extends Projectile implements IRenderable{
	
	public Fireball(int damage, int timer, Coordinate coordinate, Coordinate destination) {
	...
	public void draw(GraphicsContext gc) {
		...
		gc.drawImage(rotateImage(ImageHolder.fireballSprite, angle), getCoordinate().getX(), getCoordinate().getY());
	}
